 ...
 * @description:
 */
public class MyHttpClientPost02 {

	private final static Logger logger = Logger
			.getLogger(MyHttpClientPost02.class);
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			Part[] parts = {
					new StringPart("key", "695132533"),
					new FilePart("file", new File(System.getProperty("user.dir")
