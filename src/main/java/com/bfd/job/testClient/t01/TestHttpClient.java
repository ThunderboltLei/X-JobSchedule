 ...
 * @author: BFD474
 *
 * @description: 通过Http协议上传文件，适用于2M大小以内的文件，如果是视频等大文件应采用其他方法
 *               如果上传文本内容，可直接使用Post提交，该类主要是用于上传小文件<br>
 */
public class TestHttpClient {
	 ...
	 *            上传文件
	 */
	public static boolean post(String myurl, Map<String, String> params,
		...
		// // 完成第二个协议头的数据，可省略
		// String accept =
		// "Accept: image/gif, image/jpeg, image/pjpeg, image/pjpeg, application/x-shockwave-flash, application/xaml+xml, application/vnd.ms-xpsdocument, application/x-ms-xbap, application/x-ms-application, application/vnd.ms-excel, application/vnd.ms-powerpoint, application/msword, */*/r/n";
	...
	public static void main(String[] args) throws Exception {
		// myurl
		String myurl = "http://127.0.0.1:9999/recv";
		// params
		Map<String, String> params = new HashMap<String, String>();
		params.put("key", "hello");
		params.put("value", "world");
		// file
		File uploadFile = new File("C://Users//BFD474//Desktop//demo03.drl");
		FormFile formfile = new FormFile(uploadFile.getName(), uploadFile,
				null, null);
		// test
		boolean bool = TestHttpClient.post(myurl, params, formfile);
